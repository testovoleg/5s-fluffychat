...
enum AppSettings<T> {
  ...
  pushNotificationsGatewayUrl<String>(
    ...
    'https://push.m.5systems.ru/_matrix/push/v1/notify',
  ),
  ...
  displayNavigationRail<bool>('chat.fluffy.display_navigation_rail', true),
  ...
  applicationName<String>('chat.fluffy.application_name', '5S Chat'),
  defaultHomeserver<String>('chat.fluffy.default_homeserver', 'm.5systems.ru'),
  // colorSchemeSeed stored as ARGB int
  colorSchemeSeedInt<int>('chat.fluffy.color_scheme_seed', 0xFF5625BA),
  appLocale<String>('chat.fluffy.app_locale', 'ru'),
  ...
  chatListSpaceBadgeNotch<bool>('chat.fluffy.chat_list_space_badge_notch', true),
