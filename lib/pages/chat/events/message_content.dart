...
/// Reads Matrix `info.w` / `info.h`, which may be int, double, or string.
int? _readDimension(Object? value) {
      ...
      case EventTypes.Sticker:
        switch (event.messageType) {
          ...
          case MessageTypes.Sticker:
            ...
            // On web, JSON numbers are often doubles — tryGet<int> would fail
            // and fall back to a square crop.
            final w = _readDimension(info?['w']);
            final h = _readDimension(info?['h']);
            var width = maxSize;
            var height = maxSize;
            // Always contain so landscape/portrait images aren't cropped.
