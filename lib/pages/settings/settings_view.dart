...
import 'package:fluffychat/utils/pwa_installer.dart';
        ...
        child: ListView(
          ...
          children: <Widget>[
            ...
            ListTile(
              ...
              trailing: Text(AppSettings.appLocale.value.toUpperCase()),
              onTap: controller.changeLanguageAction,
            ),
            ListTile(
            ...
            if (PlatformInfos.isWeb)
              ValueListenableBuilder<bool>(
                valueListenable: PwaInstaller.canInstall,
                builder: (context, canInstall, _) {
                  if (!canInstall || PwaInstaller.isInstalled) {
                    return const SizedBox.shrink();
                  }
                  return ListTile(
                    leading: const Icon(Icons.install_desktop_outlined),
                    title: Text(L10n.of(context).installApp),
                    subtitle: Text(L10n.of(context).installAppDescription),
                    onTap: PwaInstaller.promptInstall,
                  );
                },
              ),
            ListTile(
