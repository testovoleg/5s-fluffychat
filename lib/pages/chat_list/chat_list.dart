...
enum ActiveFilter { allChats, spaces, unread, groups, messages, tag }
...
class ChatListController extends State<ChatList>
  ...
  Future<void> setActiveSpace(String spaceId) async {
    ...
    if (FluffyThemes.isColumnMode(context)) {
      context.go('/rooms/$spaceId/details?spaceId=$spaceId');
    }
  }
  ...
  void clearActiveSpace() {
    ...
    AppSettings.chatFilter.setItem(ActiveFilter.allChats.name);
    if (!mounted) return;
    if (FluffyThemes.isColumnMode(context)) {
      context.go('/rooms');
    }
  ...
  void didUpdateWidget(covariant ChatList oldWidget) {
    ...
    if (oldWidget.activeSpace != widget.activeSpace &&
  ...
  Future<void> onChatTap(Room room) async {
    ...
    if (spaceId != null) {
      context.go('/rooms/${room.id}?spaceId=$spaceId');
    } else {
  ...
  bool Function(Room) getRoomFilterByActiveFilter(ActiveFilter activeFilter) {
    switch (activeFilter) {
      ...
      case ActiveFilter.spaces:
        return (room) => room.isSpace;
      case ActiveFilter.unread:
        return (room) => room.isUnreadOrInvited && !room.isSpace;
      case ActiveFilter.tag:
  ...
  Future<void> _waitForFirstSync() async {
    ...
    if (client.prevBatch == null &&
        client.onSyncStatus.value?.status != SyncStatus.finished) {
